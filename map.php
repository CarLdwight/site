...
<div class="row">
    ...
    <table class="table-bordered table-hover" style="background-color: #fff !important; border: 2px solid #323232 !important;">
      ...
      <tbody id="ans">
        ...
        <div class="phone-number" style="text-align: center; width: 450px;">
          <a href="editdata.php?site_id=${shop.properties.site_id}"  class="btn"   title="Edit Data"  style="background-color: #4CAF50; border-color: #4CAF50; width: 200px; color: white;"> ${shop.properties.link}</a>
        </div>
